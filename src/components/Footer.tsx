...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-secondary py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-xs">
              Designing digital experiences with precision, elegance, and purpose.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-muted-foreground">123 Design Street, Digital City</li>
            </ul>
          </div>
        </div>
